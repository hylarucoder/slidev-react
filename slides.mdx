...
Use <Annotate type="bracket" brackets={['left', 'right']}>brackets on a focus block</Annotate>.
```

<div className="space-y-4">
  <p>We can <Annotate type="circle">circle launch</Annotate> for timing.</p>
  <p>Use <Annotate type="bracket" brackets={['left', 'right']}>brackets on a focus block</Annotate>.</p>
</div>
...
<div className="mt-8 space-y-4">
  ...
  <p>
    Or{" "}
    <Annotate type="box" revealStep={2} animate={false}>
