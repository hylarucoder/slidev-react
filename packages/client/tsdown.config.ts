...
export default defineConfig({
  entry: {
    ...
    "addons/editorial": "src/addons/builtin/editorial/index.ts",
  ...
  copy: [
    ...
    { from: "src/addons/builtin/editorial/style.css", to: "dist/addons/editorial" },
    { from: "src/theme/builtin/moonlit/style.css", to: "dist/themes/moonlit" },
  ],
  format: "esm",
  outDir: "dist",
  platform: "neutral",
